...
### 2.1. Phần Mục tiêu
Sinh viên hoàn thành phần này dựa theo 
* File “Tên và Mục tiêu” (file TXT) mà giảng viên đã cung cấp,
* Các ứng dụng hoặc hệ thống tương tự, và
* Ý tưởng đề xuất của mình nếu có.
