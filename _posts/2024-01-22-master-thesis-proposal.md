...
Học viên phân tích giải pháp theo hướng đi cụ thể đã lựa chọn.
   ...
   * #### Hướng 2.2
       ...
       * Giải pháp thủ công (trivial solution) hoặc giải pháp hiện tại hệ thống đang sử dụng để giải quyết vấn đề/bài toán này, nếu có, là gì?
       * Đã có những giải pháp nào khác đã được đề xuất để giải quyết vấn đề/bài toán này? Thông thường, phần **Related Work** của bài báo sẽ hỗ trợ thông tin cho phần phân tích này.
